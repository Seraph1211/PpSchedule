package com.seraph.ppschedule.tomato;
...
public class TomatoView extends View {
    ...
    public TomatoView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public TomatoView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        mPaint.setAntiAlias(true);  //为Paint添加抗锯齿属性
        //黑圆
        canvas.save();
